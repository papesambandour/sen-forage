	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<table class="table table-bordered table-hover table-striped" id="tabEtu">
				...
				<tbody id="tbody">
                {foreach from=$abonnees item=ligne}
					<tr>
						<td id="id{$ligne.idClient}" > ABN-{$ligne.idClient}</td>
						<td id="nom{$ligne.idClient}" >  {$ligne.nomcomplet}</td>
						<td id="village{$ligne.idClient}" > {$ligne.nomcomplet}</td>
...
{block name="js"}
	<script src="/public/js/abonnement.js"></script>
{/block}